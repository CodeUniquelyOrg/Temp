...
import { red500, amber500, blue500, indigo500, lightGreen800, grey900 } from 'material-ui/styles/colors';
...
class Tyre extends Component {
  ...
  render() {
    ...
    const tyre = (
      <div style= {{ borderRadius:'50%', width:200, height:200, backgroundColor:blue500 }}>
      </div>
    );
